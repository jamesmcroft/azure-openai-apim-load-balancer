...
@description('Name of the API Management. If empty, a unique name will be generated.')
param apiManagementName string = ''
@description('Email address for the API Management publisher.')
...
module openAIApi './core/api-management-openapi-api.bicep' = {
  ...
  params: {
    ...
    format: 'openapi-link'
    displayName: 'OpenAI'
    value: 'https://raw.githubusercontent.com/Azure/azure-rest-api-specs/main/specification/cognitiveservices/data-plane/AzureOpenAI/inference/preview/2023-09-01-preview/inference.json'
  }
}
